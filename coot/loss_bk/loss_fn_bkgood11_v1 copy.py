...
class CrossCLR(nn.Module):
    ...
    def __init__(self, temperature=0.05, logger = None):
        ...
        self.temperature = 0.04 #temperature #0.04
        self.logger = logger
    ...
    def forward(self, image_features, text_features, input_img, input_txt):
        ...
        sorted_img, indices_img = th.sort(avg_sim_img_q)
        sorted_txt, indices_txt = th.sort(avg_sim_txt_q)
        ...
        logits_clstr_img[:, indices_img_thrsh] = 0
        logits_clstr_txt[:, indices_txt_thrsh] = 0
        negatives_img = logits_clstr_img#[:, indices_img_thrsh]
